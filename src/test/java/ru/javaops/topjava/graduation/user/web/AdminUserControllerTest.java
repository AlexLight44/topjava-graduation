package ru.javaops.topjava.graduation.user.web;
...
import ru.javaops.topjava.graduation.AbstractControllerTest;
import ru.javaops.topjava.graduation.user.model.Role;
import ru.javaops.topjava.graduation.user.model.User;
import ru.javaops.topjava.graduation.user.repository.UserRepository;
...
import static ru.javaops.topjava.graduation.user.UserTestData.*;
import static ru.javaops.topjava.graduation.user.web.AdminUserController.REST_URL;
import static ru.javaops.topjava.graduation.user.web.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
